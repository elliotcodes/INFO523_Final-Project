...
setwd("~/Desktop/Fall 2021/INFO523/Final Project/Dataset")
...
## Interested in the following variables:
    ...
    # Arrested by CPD               # Total number of arrests

# Select vars of interest
varlist <- c("currentage", "dayslastarrest_num_et", "urban_yn", "race", "sex", "distlastresidence", "livewherearrested_et", "riskscore", "arrestbycpd_yn", "arrest_num") 
...
# Save subset
save(CVRM_subset, file = "info523-CVRM_Subset-02.RData")
