  ...
  navbarPage("Strategic Subjects",
            ...
            # --->  About Page
                        tabPanel("About this Project", #Markdown file with info on data & project
                                 fluidRow(
                                   column(9,
                                          # pull in an R Markdown file with text and tables
                                          includeMarkdown("About-This-Project.Rmd")
                                 ))
                                 ),

            # --->  Implications Page
                        tabPanel("Implications", #Markdown file with info on data & project
                                fluidRow(
                                   column(9,
                                  # pull in an R Markdown file with text and tables
            ...
            # --->  References Page
                        tabPanel("References",
                                 ...
                                 sidebarLayout(
                                   sidebarPanel(
                                     helpText("This page is under construction but will contain references and resources related to this project."),
                                   ),
                                   # main panel where most of the information goes
                                 mainPanel(
                                   h4("References"),
